...
fixtures.public = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `POST/${Config.web.public}/v1/users/auth`, scopes: [`login`, `logout`], query: `` } //this an example of a public path
	]
};

if (Config.app.open_development_endpoint) {
	fixtures.public.actions.push(
		{ path: `POST/${Config.web.public}/v1/dev/:action/`, scopes: [`devEndpoint`], query: `` }
	)
}
...
fixtures.policyCreate = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `POST/${Config.web.public}/v1/policies`, scopes: [`createPolicy`], query: `` }
	]
};
...
fixtures.policyRead = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/policies`, scopes: [`readPolicy`], query: `` }
	]
};
fixtures.policyUpdate = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `PUT/${Config.web.public}/v1/policies`, scopes: [`updatePolicy`], query: `` }
	]
};
fixtures.policyDelete = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `DELETE/${Config.web.public}/v1/policies`, scopes: [`deletePolicy`], query: `` }
	]
};
fixtures.configurationRead = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/configurations`, scopes: [`readConfiguration`], query: `` }
	]
};
fixtures.configurationUpdate = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `PUT/${Config.web.public}/v1/configurations`, scopes: [`updateConfiguration`], query: `` }
	]
};
...
fixtures.listProjects = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/list/`, scopes: [`listProject`] }
	]
};
fixtures.listProjects = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/:id?`, scopes: [`getProjects`] }
	]
};
...
fixtures.compileProject = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/:id/compile`, scopes: [`compileProject`] }
	]
};
...
fixtures.exportProject = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/:id/export/:type`, scopes: [`exportProject`] }
	]
};
...
fixtures.createProjects = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `POST/${Config.web.public}/v1/project/`, scopes: [`createProject`] }
	]
};
...
fixtures.updateProjects = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `PATCH/${Config.web.public}/v1/project/:id`, scopes: [`updateProject`] }
	]
};
...
fixtures.deleteProjects = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `DELETE/${Config.web.public}/v1/project/:id`, scopes: [`deleteProject`] }
	]
};
...
fixtures.listTest = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/:id/test/:id?`, scopes: [`listTest`] }
	]
};
...
fixtures.compileTest = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/:id/test/:id/compile`, scopes: [`compileTest`] }
	]
};
...
fixtures.createTest = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `POST/${Config.web.public}/v1/project/:id/test`, scopes: [`createTest`] }
	]
};
...
fixtures.updateTest = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `PATCH/${Config.web.public}/v1/project/:id/test/:id`, scopes: [`updateTest`] }
	]
};
...
fixtures.deleteTest = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `DELETE/${Config.web.public}/v1/project/:id/test/:id`, scopes: [`deleteTest`] }
	]
};
...
fixtures.listTestCase = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/:id/test/:id/case/:id?`, scopes: [`listTestCase`] }
	]
};
...
fixtures.createTestCase = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `POST/${Config.web.public}/v1/project/:id/test/:id/case/:id`, scopes: [`createTestCase`] }
	]
};
...
fixtures.updateTestCase = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `PATCH/${Config.web.public}/v1/project/:id/test/:id/case/:id`, scopes: [`updateTestCase`] }
	]
};
...
fixtures.deleteTestCase = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `DELETE/${Config.web.public}/v1/project/:id/test/:id/case/:id`, scopes: [`deleteTestCase`] }
	]
};
...
fixtures.getReportProjects = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/report/`, scopes: [`getReportProjects`] }
	]
};
fixtures.getReportProjectsUsers = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/report/user/`, scopes: [`getReportProjectsUsers`] }
	]
};
...
fixtures.getReportProjectsUser = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/report/user/:moodle_student_id/`, scopes: [`getReportProjectsUser`] }
	]
};
fixtures.getReportProjectsUsersEvolution = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/report/user/evolution/`, scopes: [`getReportProjectsUsersEvolution`] }
	]
};
fixtures.getReportProjectsUserEvolution = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/report/user/:moodle_student_id/evolution/`, scopes: [`getReportProjectsUserEvolution`] }
	]
};
...
fixtures.getReportProject = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/:id/report/`, scopes: [`getReportProject`] }
	]
};
fixtures.getReportProjectTimeline = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/:id/report/timeline/`, scopes: [`getReportProjectTimeline`] }
	]
};
fixtures.getReportStudentTimeline = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/report/user/:moodle_student_id/timeline/`, scopes: [`getReportStudentTimeline`] }
	]
};
fixtures.getReportTopicTimeline = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/report/topic/timeline/`, scopes: [`getReportTopicTimeline`] }
	]
};
fixtures.topicGet = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/topic/`, scopes: [`getTopics`] }
	]
};
...
fixtures.getReportProjectUsers = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/:id/report/user/`, scopes: [`getReportProjectUsers`] }
	]
};
fixtures.getReportProjectUser = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/project/:id/report/user/:moodle_student_id`, scopes: [`getReportProjectUser`] }
	]
};
...
fixtures.createTestSummary = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `POST/${Config.web.public}/v1/project/test/case/summary/`, scopes: [`createSummary`] }
	]
};
...
fixtures.listActivities = {
	...
	extends: [], depends: [],
	actions: [
		{ path: `GET/${Config.web.public}/v1/course/activities`, scopes: [`listMoodleActivities`] }
	]
};
